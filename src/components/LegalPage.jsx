      ...
      <div className="legal-root">
        <div className="legal-wrap">
          ...
          <nav className="legal-foot" aria-label="Legal">
            <Link href="/" className="legal-foot-home">
              &larr; Back to Craft &amp; Cup
            </Link>
            <Link href="/terms" className="legal-foot-link">
              Terms of Service
            </Link>
            <Link href="/privacy" className="legal-foot-link">
              Privacy Policy
            </Link>
          </nav>
        </div>
