...
const BREW_CONFIGS = {
  "Pour Over / V60": {
    ...
    grindDesc: "Like coarse sand. A bit finer than drip, a bit coarser than espresso",
    bloomTime: "30-45s",
    brewTime: "2:30-3:30",
    cupVolume: 250,
  ...
  Chemex: {
    ...
    grindDesc: "Coarser than V60 due to the thicker Chemex filter",
    bloomTime: "45s",
    brewTime: "4:00-5:00",
    cupVolume: 300,
  ...
  Espresso: {
    ...
    tempF: 200,
    grindSize: "Fine",
    grindDesc: "Very fine, like powdered sugar. Dial in by taste and shot time",
    brewTime: "25-30s",
    cupVolume: null,
  ...
  "Cold Brew": {
    ...
    tempF: null,
    grindSize: "Coarse",
    grindDesc: "Very coarse, like rough sea salt. The long steep compensates for the open grind",
    steepHours: "12-24",
    cupVolume: 250,
  ...
  "French Press": {
    ...
    tempF: 201,
    grindSize: "Coarse",
    grindDesc: "Coarse and even, like rough sea salt. A fine grind will make it bitter and hard to press",
    brewTime: "4:00",
    cupVolume: 300,
  ...
  AeroPress: {
    ...
    tempF: 185,
    grindSize: "Medium-Fine",
    grindDesc: "Medium-fine, like table salt. Go coarser for a longer steep, finer for shorter",
    brewTime: "1:30-2:00",
    cupVolume: 200,
  ...
  "Moka Pot": {
    ...
    tempF: null,
    grindSize: "Fine",
    grindDesc: "Fine but not espresso-fine. Like table salt. Too fine and it'll clog the filter",
    brewTime: "4:00-5:00",
    cupVolume: 60,
  ...
  "Drip Machine": {
    ...
    tempF: 200,
    grindSize: "Medium",
    grindDesc: "Medium, like coarse sand. Consistent grind size matters more than almost anything else for drip",
    brewTime: "5:00-8:00",
    cupVolume: 237,
...
const GRIND_GUIDE = [
  { size: "Extra Coarse", color: "#c8a878", desc: "Like coarse pebbles or wood chips. Used for Cold Brew the long steep extracts slowly so you need a very open grind to avoid over-extraction.", methods: ["Cold Brew"] },
  { size: "Coarse",       color: "#b89060", desc: "Like rough sea salt. Ideal for French Press and Cold Brew concentrate. The coarse grind allows full immersion without getting bitter or muddy.", methods: ["French Press", "Cold Brew"] },
  { size: "Medium-Coarse",color: "#c09858", desc: "Like coarse sand. Perfect for Chemex the thick paper filter slows flow, so a coarser grind prevents over-extraction during the longer brew time.", methods: ["Chemex"] },
  { size: "Medium",       color: "#b88848", desc: "Like regular table sand. The all-purpose grind. Great for Drip machines where consistent, moderate extraction is the goal.", methods: ["Drip Machine"] },
  { size: "Medium-Fine",  color: "#c09040", desc: "Like finer sand, just barely coarser than table salt. Used for Pour Over and AeroPress balances flow rate with good extraction in a relatively short brew.", methods: ["Pour Over / V60", "AeroPress"] },
  { size: "Fine",         color: "#a87838", desc: "Like table salt or fine sugar. Used for Espresso and Moka Pot. The fine grind creates resistance so pressurized brewing can extract efficiently in under 30 seconds.", methods: ["Espresso", "Moka Pot"] },
  { size: "Extra Fine",   color: "#906030", desc: "Like powdered sugar or flour. Used only for Turkish coffee it's steeped directly in water and never filtered, so the ultra-fine grind is part of the experience.", methods: ["Turkish Coffee"] },
];
