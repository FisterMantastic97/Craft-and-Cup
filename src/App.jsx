...
const BREW_CONFIGS = {
  ...
  Chemex: {
    ...
    grindDesc: "One step coarser than V60. The Chemex filter is much thicker and slows drainage significantly — a finer grind will choke it and over-extract.",
    bloomTime: "45s",
    brewTime: "4:00-5:00",
    cupVolume: 300,
  ...
  "Drip Machine": {
    ...
    tempF: 200,
    grindSize: "Medium",
    grindDesc: "Medium and consistent. Drip machines are calibrated for this grind size — going finer makes it bitter, coarser makes it weak and flat.",
    brewTime: "5:00-8:00",
    cupVolume: 237,
