...
export default function Privacy() {
  return (
    <>
      <PageMeta
        title="Privacy Policy - Craft & Cup"
      ...
      >
        ...
        <p>
          ...
          from that provider - typically your email address, name, a provider account identifier,
          and (if available) an avatar image. We do not receive or store your password for those
          providers.
        </p>

        <h3>Profile and content you create</h3>
        <p>
          We store the content you add to build your journal: your screenname and display name,
          beans, recipes, tasting notes, scores, brew details, collections, and any photos you
          upload.{" "}
          <strong>
            Photos you upload are stored in our image storage and served through public URLs
          </strong>
          , which means an image can be viewed by anyone who has its link. Content you mark as
          public - including your public profile - may be visible to anyone on the internet.
        </p>
        ...
        <p>
          When you ask Craft &amp; Cup to build a flavor profile, the relevant text you entered
          (such as your tasting notes or recipe ingredients) is sent to a third-party AI provider (
          <span className="ph">[name of AI provider]</span>) which processes it and returns a flavor
          mapping. We send only the text needed for that feature. Please review that
          provider&rsquo;s practices for details on how they handle data; you can find their policy
          at <span className="ph">[link to AI provider policy]</span>.
        </p>
        ...
        <ul>
          <li>
            ...
            <strong>Google</strong> or <strong>Discord</strong>), and our{" "}
            <strong>AI provider</strong> for flavor analysis;
          </li>
          <li>
          ...
          <li>
            ...
            required by law or necessary to protect the Service, our rights, or people&rsquo;s
            safety; and
          </li>
          <li>
            <strong>In a business transfer</strong>, such as a merger or acquisition, in which case
        ...
        <p>
          ...
          plus the privacy-conscious analytics described above. We do not use third-party
          advertising cookies. You can clear local storage and cookies in your browser settings,
        ...
        <p>
          ...
          personal information within a reasonable period, except where we need to retain it to
          comply with legal obligations, resolve disputes, or enforce our agreements, and except for
          content you have already shared with others.
        </p>

        <h2>7. Security</h2>
        <p>
          We use reasonable technical and organizational measures - including reputable
          infrastructure providers and access controls - to protect your information. No method of
        ...
        <p>
          ...
          your personal information, or to object to or restrict certain processing. You can edit
          much of your information directly in the app, and you can request account deletion or a
          copy of your data by contacting us at <span className="ph">[contact email]</span>. We will
          respond consistent with applicable law. If you are in the EU/UK, our legal bases for
          processing include performing our contract with you, your consent (which you may
          withdraw), and our legitimate interests in operating and improving the Service.
        </p>

        <h2>9. Children&rsquo;s privacy</h2>
        <p>
          The Service is not directed to children under <span className="ph">13</span>, and we do
          not knowingly collect personal information from them. If you believe a child has provided
        ...
        <p>
          ...
          notify you. Your continued use of the Service after changes take effect means you accept
          the updated policy.
        </p>
